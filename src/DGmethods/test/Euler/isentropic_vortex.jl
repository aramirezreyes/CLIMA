...
let
  ...
  # Different than isentropic_vortex_standalone due to energy differences
  expected_error[1,1] = 3.1328357274900513e+03
  expected_error[1,2] = 6.6388104439026677e+02
  expected_error[1,3] = 3.3340876699049993e+01
  expected_error[2,1] = 9.9068964333589684e+03
  expected_error[2,2] = 2.0993761953498583e+03
  expected_error[2,3] = 1.0543311080708403e+02
